  ...
  return (
    <div className="gp-grid">
      ...
      <div style={{
        ...
        leakage: none — forecast generated from 2000–2024 data only · 2025 actuals excluded from training · used for post-hoc validation only
      </div>
      ...
      <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '1rem' }}>
        ...
        <DashboardCard
          ...
          subtitle="Annual mean generation 2000–2025 · 50 MW solar site"
        >
